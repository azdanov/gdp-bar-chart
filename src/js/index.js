...
d3.json("https://cdn.rawgit.com/azdanov/gdp-line-chart/19384513/src/data/data.json", (error, json) => {
    ...
    function mouseMove() {
        ...
        tooltip.select(".year").text(() => `${calcQuarter(d.year.getMonth())} ${d.year.getFullYear()}`);
        tooltip.style("left", `${d3.event.pageX - 30}px`).style("top", `${d3.event.pageY - 30}px`);
